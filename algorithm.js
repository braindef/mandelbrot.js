...
{
  var c_re = (posX*scale+offsetX ) * 4.0/zoom;
  var c_im = (posY*scale+offsetY ) * 4.0/zoom;
  ...
  if( (posX%100==0)&&(posY%100==0)  )
  {
    ...
    ctx.fillStyle = "white";
    ctx.fillText(posX+"-"+posY,posX-40,posY);
    ctx.fillText(parseInt((posX+offsetX)/zoom)+"-"+parseInt((posY+offsetY)/zoom),posX-40,posY+15);
    //console.log(posX + " -- " + posY);  
  }
}
